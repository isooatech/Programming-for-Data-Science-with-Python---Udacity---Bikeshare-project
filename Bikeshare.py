...
def get_filters():
    ...
    city = input('Chicago, New York City and Washingston data are available. \nPlease enter the name of the state you would like to explore ').lower().strip()
    ...
    if city in CITY_DATA:
        ...
        month = input('Would you like to view all months or a specific month between january and june').lower().strip()
        
        #Handling wrong input errors
        if month in Available_months:
             # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
        
            day = input('Would you like to view all days of the week or a specific day of week').lower().strip()
        
            #Handling wrong input errors
            
            while day not in Available_day_of_week:
                print('You have made an incorrect input')
                day_loop = input('Will you like to continue with a correct day input? \nEnter Y for Yes or any other character to exit ').lower().strip()
                if day_loop == 'y':
                    day = input('Now enter the correct day ').lower().strip()
                    continue
                else:
                    day = day_loop
                    break
            ...
            while month not in Available_months:
                ...
                if month_loop == 'y':
                    month = input('Now enter the correct month ').lower().strip()
                    continue
                else:
                    month = month_loop
                    break
        ...
        while city not in CITY_DATA:
            print('You have made an incorrect input')
            loop = input('Will you like to continue? Enter Y for Yes or any other character to exit ').lower().strip()
            if loop == 'y':
                city = input('Now enter the correct city ').lower().strip()
                continue
            else:
                city = loop
                break
